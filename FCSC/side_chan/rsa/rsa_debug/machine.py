...
class Machine:
    ...
    def fetchInstruction(self):
        ...
        try:
            print(f"                            @{self.pc}=> {self.instruction.__name__} {self.dst} {str(self.a)[:10]}, {str(self.b)[:10]}")
        except:
    ...
    def showStatus(self):
        #return
        print(f"="*24)
        print(f"R0: {self.R0} result, cte_1")
        print(f"="*24)
        print(f"R1: {self.R1} m1, tmp1")
        print(f"R2: {self.R2} m2, tmp2")
        print(f"R3: {self.R3} h")
        print(f"R4: {self.R4} tmp ")
        print(f"="*24)
        print(f"R5: {self.R5} message, ct")
        print(f"R6: {self.R6} p")
        print(f"R7: {self.R7} q")
        print(f"="*24)
        print(f"R8: {self.R8} qinv ")
        print(f"R9: {self.R9} dp")
        print(f"RA: {self.RA} dq")
        print(f"RB: {self.RB} e")
        try:
            print(f"RC: {self.exponent} exp")
        except:
            print(f"RC: N/A exp")

        try:
            print(f"RD: {self.module} modulo, N ")
        except:
            print(f"RC: N/A exp")
        #print(f"RE: {self.RE}")
        #print(f"RF: {self.RF}")
    ...
    def runCode(self):
        print("runing code with initial state:")
        self.showStatus()
        while True:
            t = self.pc
            self.fetchInstruction()
            if self.end or self.error:
                                print("broken in fetch")
            self.executeInstruction()
            if self.end or self.error:
                                print("broken in execute")
            self.showStatus()
            if self.end or self.error:
                                    print("broken in showstatus")
